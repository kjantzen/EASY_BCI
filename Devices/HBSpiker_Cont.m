...
classdef HBSpiker_Cont < handle
    ...
    properties (Constant = true)
        SampleRate = 500;
        %conversion is refVoltage/maxsample/gain * 1 million (to represent
        %in uV)
        ADC2MV =  (5/1024)/3840 * 1000000;
    end

    methods
        function obj = HBSpiker_Cont(port, varargin)
            if nargin > 3
